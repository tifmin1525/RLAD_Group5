...
#### 第一種方式：建立一個 Facebook App，以取得通過 Facebook 的權限認證機制，
  ...
  - OAuth Settings：
    - 到左下按「新增產品」
    - 選「Facebook 登入」-「設定」- 「網站」- 填入 http://localhost:1410/ - 儲存
...
```{r}
token <- 'EAACEdEose0cBAK65fKDTxlZBnE6dMcZBeVemfzWSKJQ76uAwk66ulhF6c38TmDBCGZBweNZBqM8fyO6yn798H9Rm1SGR3R3YFX6DeWh2elqoup4JoBwD3Ui2QuJaZBa133NVXgB8WuZAjbKdkhFfDIjnx3x29zVPeMStSUaZBQMdBFIYSLK2M7OZAFyJkWZAkxdppbdvtattrPwZDZD'
